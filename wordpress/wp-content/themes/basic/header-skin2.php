...
<section class="wpo-page row-offcanvas row-offcanvas-left">
	...
	<section class="wpo-wrapper">
		...
		<!-- // Topbar -->
		<!-- HEADER -->
		<header id="wpo-header" class="wpo-header header-inverse">
            <div class="container">
    			<div class="container-inner header-top header-wrap clearfix">    				
                    ...
                    <div class="col-md-offset-4">
                        <div class="header-column">
                            <div class="hidden-xs text-left search-has-category">
    ...
    <!-- MENU -->
    <nav id="wpo-mainnav" data-duration="<?php echo wpo_theme_options('megamenu-duration',400); ?>" class="wpo-megamenu <?php echo wpo_theme_options('magemenu-animation','slide'); ?> animate navbar navbar-mega navbar-mega-full-width" role="navigation">
        <div class="container">
