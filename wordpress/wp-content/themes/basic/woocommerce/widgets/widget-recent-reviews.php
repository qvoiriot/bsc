	 ...
	 public function widget( $args, $instance ) {
		...
		if ( $comments ) {
			...
			foreach ( (array) $comments as $comment ) {
				...
				echo '<div class="media widget-product"><a href="' . esc_url( get_comment_link( $comment->comment_ID ) ) . '" class="image media-left media-middle">';
				...
				printf( '<div class="review"><span class="reviewer">' . _x( 'by %1$s', 'by comment author', 'basic' ) . '</span></div>', get_comment_author() );
