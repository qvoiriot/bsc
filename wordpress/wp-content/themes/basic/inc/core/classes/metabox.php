...
class WPO_MetaBox
{
	...
	?>
        ...
        <select name="<?php $this->the_name(); ?>" id="<?php echo esc_attr( $item['id'] ); ?>">
	        <?php foreach($item['data'] as $layout){ ?>
	            <option value="<?php echo esc_attr( $layout['id'] ); ?>" <?php $this->the_select_state($layout['id']); ?>><?php echo esc_html( $layout['name'] ); ?></option>
	        <?php } ?>
        </select>
	...
	?>
		<label><?php echo esc_html( $item['title'] ); ?></label>
        <input type="text" name="<?php $this->the_name(); ?>" style="width: 500px" id="<?php echo esc_attr( $item['id'] );?>" value="<?php $this->the_value(); ?>"/>
	...
	?>
		<label><?php echo esc_html( $item['title'] ); ?></label>
        <input type="number" name="<?php $this->the_name(); ?>" style="width: 100px" id="<?php echo esc_attr( $item['id'] );?>" value="<?php $this->the_value(); ?>"/>
        <br/><?php echo ( $item['des'] ); ?>
        <p>
    <?php
	}
	...
	?>
		<label><?php echo esc_html( $item['title'] ); ?></label>
        <textarea class="textarea " style="width: 500px; height: 100px" name="<?php $this->the_name(); ?>" id="<?php echo esc_attr( $item['id'] ) ?>"><?php $this->the_value(); ?></textarea>
	<?php
	}
	...
	?>
		<label><?php _e( 'Background color ', 'basic')?></label>
...
?>
		<p class="wpo_section page-layout">
		    ...
		    <select  name="<?php $this->the_name(); ?>" style="display:none;">
		    	<option value="0-1-0" <?php $this->the_select_state('0-1-0'); ?>><?php echo __('Fullwidth','basic'); ?></option>
		    	<option value="1-1-0" <?php $this->the_select_state('1-1-0'); ?>><?php echo __('Left Sidebar','basic'); ?></option>
		    	<option value="0-1-1" <?php $this->the_select_state('0-1-1'); ?>><?php echo __('Right Sidebar','basic'); ?></option>
		    	<option value="1-1-1" <?php $this->the_select_state('1-1-1'); ?>><?php echo __('Left & Right Sidebar','basic'); ?></option>
		    </select>
		</p>
<?php
	}
	...
	function getDefaultData($item){
		$default_data = $this->check_key_value($item['id'],$this->custom_data);
		if($default_data != ''){
