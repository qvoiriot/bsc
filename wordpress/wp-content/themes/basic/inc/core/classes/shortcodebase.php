...
abstract class WPO_Shortcode_Base{
	...
	?>
			...
			<button type="button" class="btn btn-primary wpo-button-save"><?php echo __('Save', 'basic'); ?></button>
			<button type="button" class="btn btn-default wpo-button-back"><?php echo __('Back to list', 'basic'); ?></button>
	...
	private function renderUploader( $_id, $_name ) {
		...
		$output .= '<input id="' . $id . '" class="upload" type="text" name="'.$name.'" placeholder="' . __('No file chosen', 'basic') .'" />' . "\n";
