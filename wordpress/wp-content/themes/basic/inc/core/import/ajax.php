...
class PbrThemer_Import_Ajax{
	...
	public static function pbrthemer_contentImport(){
		...
		$importObj->import_content($folder.$_POST['xml']);
	...
	public static function pbrthemer_vc_templatesImport()
	{
		...
		$importObj->import_content($_POST['demo_source'] . "/vc_templates.xml");
	...
	{	
		...
		$importObj->import_rev_slider($_POST['demo_source']);
	...
	public static function pbrthemer_essential_gridImport()
	{
		...
		$importObj->import_essential_grid($_POST['demo_source'] . '/essential_grid.txt');
	...
	public function pbrthemer_customizer_optionsImport()
	{
		...
		$importObj->import_customizer_options($_POST['demo_source'] . '/skins/Skin 1.txt');
	...
	public static function pbrthemer_page_optionsImport()
	{
		...
		$importObj->import_theme_options( $_POST['demo_source'] . '/options.txt' );
		if( !self::$batch ) { die(); }
	}
	...
	public static function pbrthemer_menusImport()
	{
		...
		$importObj->import_menus($_POST['demo_source'] . '/menus.txt');
	...
	public static function pbrthemer_widgetsImport() {
		...
		// Import widget logic
		$importObj->import_widget_logic( $folder.'widget_logic_options.txt' );
