...
class WPO_Flickr_Widget extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Flickr', 'basic'),
            // Widget description
            array( 'description' => __( 'The most recent photos from flickr.', 'basic' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        <p>
            ...
            <input class="widefat" type="text" id="<?php echo $this->get_field_id('screen_name'); ?>" name="<?php echo $this->get_field_name('screen_name'); ?>" value="<?php echo esc_attr($instance['screen_name']); ?>" />
        </p>


        <p>
            <label for="<?php echo $this->get_field_id('number'); ?>">Number of photos to show:</label>
            <input class="widefat" type="text" style="width: 30px;" id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" value="<?php echo esc_attr($instance['number']); ?>" />
        </p>
