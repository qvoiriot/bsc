...
class WPO_Recent_Comment extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Recent Comments Widget', 'basic'),
            // Widget description
            array( 'description' => __( 'Show list of recent comments', 'basic' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'basic' ); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'number_comment' ); ?>"><?php _e( 'Num Comments:', 'basic' ); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id( 'number_comment' ); ?>" name="<?php echo $this->get_field_name( 'number_comment' ); ?>" type="text" value="<?php echo  esc_attr($number_comment); ?>" />
        </p>
<?php
    }
