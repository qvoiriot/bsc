...
class WPO_Posts extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Posts Widget', 'basic'),
            // Widget description
            array( 'description' => __( '', 'basic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'ids' ); ?>"><?php echo __( 'Posts:', 'basic' ); ?></label>
            <br>
            <select multiple name="<?php echo $this->get_field_name( 'ids' ); ?>[]" id="<?php echo $this->get_field_id( 'ids' ); ?>" style="width:100%;height:250px;">
               <?php foreach( $posts as $value ){ ?>
                ...
                <option value="<?php echo esc_attr($value->ID); ?>" <?php echo $selected; ?>>
