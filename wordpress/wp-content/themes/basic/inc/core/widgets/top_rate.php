    ...
    class WPO_Top_Rate_Widget extends WPO_Widget {
        public function __construct() {
            parent::__construct(
                ...
                __('WPO Top Rate Widget', 'basic'),
                // Widget description
                array( 'description' => __( 'The highest rated posts on your site', 'basic' ), )
            );
        ...
        public function widget( $args, $instance ) {
            ...
            $title      = apply_filters('widget_title', empty($instance['title']) ? __('Top Rated', 'basic') : $instance['title'], $instance, $this->id_base);
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id('post_type'); ?>"><?php _e('Get most rated:', 'basic'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('sort'); ?>"><?php _e('Sort by:', 'basic'); ?></label>
                <select class="widefat" id="<?php echo $this->get_field_id('sort'); ?>" name="<?php echo $this->get_field_name('sort'); ?>">
                <option <?php selected('bayesian_rating', $instance['sort']); ?> value="bayesian_rating"><?php _e('Overall bayesian rating (score)', 'basic'); ?></option>
                <option <?php selected('rating', $instance['sort']); ?> value="rating"><?php _e('Average rating', 'basic'); ?></option>
                <option <?php selected('votes', $instance['sort']); ?> value="votes"><?php _e('Number of votes', 'basic'); ?></option>
                </select>
            </p>
            ...
            <p>
                ...
                <?php _e('Ascending', 'basic'); ?>
                </label>
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('date_limit'); ?>"><?php _e('Ignore posts older than:', 'basic'); ?></label>
                <input id="<?php echo $this->get_field_id('date_limit'); ?>" name="<?php echo $this->get_field_name('date_limit'); ?>" type="text" value="<?php echo $instance['date_limit']; ?>" size="3" /> <?php _e('days', 'basic'); ?>
                <br />
                <small><?php _e('(0 to ignore date)', 'basic'); ?></small>
            </p>

            <p>
                <label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Limit:', 'basic'); ?></label>
