    ...
    class WPO_Featured_Post_Widget extends WPO_Widget {
        public function __construct() {
            parent::__construct(
                ...
                __('WPO Featured Post Widget', 'basic')
            );
        ...
        public function form( $instance ) {
            ...
            <p>
                ...
                <select name="<?php echo $this->get_field_name( 'layout' ); ?>" id="<?php echo $this->get_field_id( 'layout' ); ?>">
                    <?php foreach ($this->selectLayout() as $key => $value): ?>
                        <option value="<?php echo esc_attr($value); ?>" <?php selected( $instance['layout'], $value ); ?>><?php echo $value; ?></option>
                    <?php endforeach; ?>
                </select>
            </p>
            <p>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('num'); ?>"><?php __('Limit:', 'basic'); ?></label>
                <br>
