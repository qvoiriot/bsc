...
class WPO_Contact_Info_Widget extends WPO_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Contact Info Widget', 'basic'),
            // Widget description
            array( 'description' => __( 'Add contact information. ', 'basic' ), )
        );
        $this->widgetName = 'contact-info';
        
        $this->params = array(
            'title' => __('Title', 'basic'), 
            'description' => __('Description', 'basic'), 
            'company' => __('Company', 'basic'), 
            'country' => __('Country', 'basic'), 
            'locality' => __('Locality', 'basic'),
            'region' => __('Region', 'basic'),
            'street' => __('Street', 'basic'),
            'working-days' => __('Working Days', 'basic'),
            'working-hours' => __('Working Hours', 'basic'),
            'phone' => __('Phone', 'basic'),
            'mobile' => __('Mobile', 'basic'),
            'fax' => __('Fax', 'basic'),
            'skype' => __('Skype', 'basic'),
            'email-address' => __('Email Address', 'basic'),
            'email' => __('Email', 'basic'),
            'website-url' => __('Website URL', 'basic'),
            'website' => __('Website', 'basic')
        );
    }
    ...
    function form($instance) {
        $defaults = array('title' => __('Contact Info', 'basic'));
