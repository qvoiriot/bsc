...
<div class="megamenu-pages container">
	...
	<div class="row">
		<div class="col-md-12">
			<h1><?php echo __( 'Megamenu Editor', 'basic' );?></h1>
		</div>
		<div class="col-md-12">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo __('Close','basic');?></button>
        </div>
      </div>
    </div>
  </div>
						...
						<div id="column-form" style="display: none; left: 340px; top: 45px;" class="popover top   form-setting">
							...
							<div class="popover-content">
								...
								<table class="table table-hover">
									...
									<tr>
										<td><?php echo __('Column Width', 'basic');?></td>
										<td>
...
<script type="text/javascript">
	...
	jQuery( function($) {
		...
		$("#menugroup").change( function(){	 
			if( $("#menugroup").val() ){ 
				location.href="<?php echo $liveedit_action ?>&group="+$("#menugroup").val();
			}
		} );
