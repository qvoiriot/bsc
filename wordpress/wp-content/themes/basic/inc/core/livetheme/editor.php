				...
				<div id="customize-form">
					...
					<div class="groups clearfix">
						<div class="form-group pull-left">
							<label><?php echo __('Css Profiles:', 'basic'); ?></label>
							<select name="saved_file" id="saved-files" style="width:auto;">
								<option value=""> ------------- </option>
								<?php foreach( $files as $file ){ $file = str_replace( ".css","", $file); ?>
									<option value="<?php echo $file;?>"><?php echo esc_html( $file ); ?></option>
								<?php } ?>
							</select>
						</div>

						<div class="form-group ">
							<label class="show-for-notexisted"><?php echo __('And Named This: ', 'basic'); ?></label>
							<label class="show-for-existed"><?php echo __('And Rename To:', 'basic'); ?></label>
												...
												<div class="accordion-inner panel-body clearfix">
													...
													<?php  if (isset($item['type'])&&$item['type']=="image") { ?>
														<div class="form-group background-images">
															...
															<p>
																<em style="font-size:10px"><?php echo __('Those Images in folder YOURTHEME/images/bg/', 'basic') ?></em>
															</p>
															<div class="bi-wrapper clearfix">
																<?php foreach ( $patterns as $pattern ){ ?>
																<div style="background:url('<?php echo $backgroundImageURL.$pattern;?>') no-repeat center center;" class="pull-left" data-image="<?php echo esc_attr( $backgroundImageURL.$pattern );?>" data-name="<?php echo esc_attr( $pattern ); ?>" data-val="<?php echo esc_attr( $pattern ); ?>">
