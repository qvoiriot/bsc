...
<div class="widget wpo-reassuarence <?php echo esc_attr( $el_class ).' '.esc_attr($alignment); ?> <?php echo esc_attr($style) ;?>">
		<?php if( isset($img[0]) ) { ?>
			<div class="reassuarence-icon">
		 		<img src="<?php echo esc_url( $img[0] );?>" title="<?php echo esc_html( $title ); ?>" class="image-icon">
		 	</div>
		 <?php }else if( $icon ) { ?>
		 	<div class="reassuarence-icon">
