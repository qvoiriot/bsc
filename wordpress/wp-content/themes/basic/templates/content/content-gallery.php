...
?>
	<?php if(count($galleries) > 1) { ?>
			...
			<div id="post-slide-<?php the_ID(); ?>" class="carousel slide" data-ride="carousel">
				...
				<a class="left carousel-control post-carousel-control" href="#post-slide-<?php the_ID(); ?>" data-slide="prev">
					<span class="fa fa-angle-left"></span>
				</a>
				<a class="right carousel-control post-carousel-control" href="#post-slide-<?php the_ID(); ?>" data-slide="next">
