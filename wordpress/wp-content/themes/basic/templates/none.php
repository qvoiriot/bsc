<section class="cat-top  page-found clearfix">
	<header class="header-title">
		<h6 class="page-title"><?php echo __( 'Nothing Found', 'basic' ); ?></h6>
	</header><!-- /header -->
</section>
<article class="wrapper">
	...
	<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with different keywords.', 'basic' ); ?></p>
	<?php get_search_form(); ?>
